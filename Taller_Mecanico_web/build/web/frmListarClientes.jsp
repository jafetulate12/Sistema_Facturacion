<%-- 
    ...
    Created on : 04-sep-2023, 15:15:59
    Author     : Usuario
--%>
       ...
       <header>
        ...
        <form action= "frmListarClientes.jsp" method = "post"> 
                ...
                <tbody>
                    <% 
                        ...
                        if(request.getParameter("txtNombre")!=null){
                            ...
                            condicion = "NOMBRECLIENTE LIKE '%" + nombre + "%' " ;
                        }
            ...
            if (request.getParameter("mensajeEliminarCliente")!=null) {
                    ...
                    (request.getParameter("mensajeEliminarCliente").getBytes("ISO-8859-1"),"UTF-8")+"</p>");
                }
            %>
            <a href="frmClientes.jsp?idCrearModificar=-1" class="btn btn-primary"> Agregar Cliente</a>
