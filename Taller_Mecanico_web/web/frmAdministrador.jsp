   <%-- 
    ...
    Created on : 05-sep-2023, 17:30:15
    Author     : Usuario
--%>
            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    ...
                    <%
                        ...
                        if (codigo>0) {
                                administrador= logica.ObtenerAdministrador("IDADMINISTRADOR="+id);
                            } else{
                            administrador=new Administrador();
                     
                        }
                    %>
                    <form action="CrearModificarAdministrador" method="post" id="form_AgregarModificar">
                        <div class="form-group">
                            <%if (codigo>0) { %>
                            <!-- si existe lo muestro el codigo -->
                             <label for="txtCodigo" class="control-label" > Codigo </label>
                             <input type="text" id="txtCodigo" name="txtCodigo" value="<%=administrador.getIdAdministrador()%>" readonly
                                    class="form-control" > 
                            <%}else{%>  
                              ...
                              <div class="form-group"><!-- comment -->
                                  <div class="input-group"> 
                                      ...
                                      <input type="button" id="btnRegresar"  value="Regresar" 
                                             onclick="location.href='frmListarAdministrador.jsp'" class="btn btn-secondary m3"/>
                                  </div>
                              </div>
                            </div>
                    </form>
